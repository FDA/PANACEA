...
import com.eng.cber.na.graph.BuildGraphFromReportedTermsExcept;
 ...
 * reports that do not contain the selected terms.  The selection must
...
public class PullReportsExcludingTerms extends BaseCommand{
	@Override
	public void execute(String name) {
		...
		SwingUtilities.invokeLater(new BuildGraphFromReportedTermsExcept(pickedState.getPicked()));
	}
