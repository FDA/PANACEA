...
import com.eng.cber.na.graph.BuildGraphFromReportedTermsAny;
 ...
 * reports that contain any of the selected terms.  The selection must
...
public class PullReportsWithSelectedTerms extends BaseCommand{
	@Override
	public void execute(String name) {
		...
		SwingUtilities.invokeLater(new BuildGraphFromReportedTermsAny(pickedState.getPicked()));
	}
